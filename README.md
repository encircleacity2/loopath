...
[![Watch the Loopath intro](media/intro/loopath-intro-cover.png)](https://github.com/encircleacity2/loopath/blob/main/media/intro/loopath-intro.mp4)

Click the cover to play the intro video on GitHub.

The video has no TTS narration. It uses generated background music and motion-graphic frames to preview the course.
...
[![观看 Loopath 介绍视频](media/intro/loopath-intro-cover.png)](https://github.com/encircleacity2/loopath/blob/main/media/intro/loopath-intro.mp4)

点击封面即可在 GitHub 上播放介绍视频。

视频没有 TTS 配音，使用生成式背景音乐和 motion graphic 画面预览课程内容。
